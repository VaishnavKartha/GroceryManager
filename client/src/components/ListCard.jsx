...
const ListCard = ({getListDetails,id,name,status,createdAt,updatedAt}) => {
  ...
  return (
    <div onClick={()=>getListDetails(id)} className=' cursor-pointer h-[200px] md:h-[250px] lg:h-[300px] w-full rounded shadow-lg list-card'>

        <img src={shopping} className="h-full w-full object-cover object-center rounded"/>

        <span className=' absolute right-0 top-0 hover:bg-text-sec/30 px-1 py-0.5'><Trash size={"20px"} stroke='red'/></span>
