    ...
    <>
        ...
        <div className='flex h-screen border m-8 mt-1 overflow-hidden relative'>
            ...
            <section className={`overflow-hidden z-20 sticky left-0 top-0 w-0 lg:w-[200px] h-full border-r ${open?"w-[200px]":"w-0"} transition-all duration-200 ease-in-out `}>
                <GroupLists selectedGroup={selectedGroup} setSelectedGroup={setSelectedGroup} skeletonLoading={skeletonLoading}/>
            </section>
            ...
            {(selectedGroupDetails && selectedGroup) && <GroupContainer details={selectedGroupDetails} selectedGroup={selectedGroup} setSelectedGroup={setSelectedGroup}/>}
